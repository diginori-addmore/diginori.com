    ...
    <main className="flex min-h-screen flex-col items-center p-8 md:p-24 bg-gray-50">
      <div className="max-w-4xl w-full">
        ...
        <div className="space-y-10 text-lg text-gray-700 leading-relaxed">
          ...
          <section>
            <p>
              과천시 지식정보타운의 완공과 함께, 디지노리는 청년과 함께하는 창업의 새로운 베이스캠프로 자리매김하고 있습니다. 네이버 출신의 25년 개발 경력을 자랑하는 민경국 대표를 중심으로, 마케팅, 개발, 디자인 분야의 재능 있는 청년 4명이 모였습니다. 또한 우리의 부족함을 채우기 위한 조선의협객전을 개발하고 아직도 LLM AI 을 사용하는 현직 개발자 선배님도 고문으로 위촉 하였습니다. 우리는 과천이라는 고향에서 새로운 성공 신화를 만들고자 합니다.
            </p>
          </section>
