    ...
    <main className="flex min-h-screen flex-col items-center p-8 md:p-24 bg-gray-50">
      <div className="max-w-4xl w-full">
        ...
        <div className="space-y-10 text-lg text-gray-700 leading-relaxed">
          ...
          <section>
            <p>
              과천시 지식정보타운의 완공과 함께, 디지노리는 청년과 함께하는 창업의 새로운 베이스캠프로 자리매김하고 있습니다. 네이버 출신의 25년 개발 경력을 자랑하는 민경국 대표를 중심으로, 마케팅, 개발, 디자인 분야의 재능 있는 청년 4명이 모였습니다. 또한 우리의 부족함을 채우기 위한 조선협객전을 개발하고 아직도 LLM AI 을 사용하는 현직 개발자 선배님도 고문으로 위촉 하였습니다. 우리는 과천이라는 고향에서 새로운 성공 신화를 만들고자 합니다.
            </p>
          </section>

          <section className="p-6 bg-white rounded-lg shadow">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">비전과 협력</h2>
            <p>
          ...
          <section className="p-6 bg-white rounded-lg shadow">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">우주를 향한 도전: 새로운 게임</h2>
            <p>
              디지노리의 첫 번째 야심작은 전전 연령을 위한 우주 게임입니다. 플레이어는 &apos;줍스&apos;와 함께 우주 쓰레기를 청소하며, 인류의 오랜 꿈인 우주 개발과 여행에 대한 흥미로운 이야기를 체험하게 됩니다. 이미 글로벌 100개국에 티저 사이트를 배포했으며, 젊은 감각의 마케팅 및 데이터 분석팀이 성공적인 론칭을 위해 밤낮없이 열띤 논의를 이어가고 있습니다.
            </p>
          </section>

          <section className="p-6 bg-white rounded-lg shadow">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">든든한 지지</h2>
            <p>
          ...
          <section className="p-6 bg-white rounded-lg shadow">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">실패 140</h2>
            <p>
          ...
          <section className="p-6 bg-white rounded-lg shadow">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">멀리 가려면 함께 가라</h2>
            <p>
